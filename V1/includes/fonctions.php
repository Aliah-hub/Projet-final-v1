...
function inscrire_membre($nom, $date_naissance, $genre, $mail, $ville, $mdp) {
    global $bdd;
    ...
    $requete = "INSERT INTO vmembre (nom, date_naissance, genre, mail, ville, mdp) VALUES ('$nom', '$date_naissance', '$genre', '$mail', '$ville', '$mdp')";
...
function connecter_membre($mail, $mdp) {
    global $bdd;
    $mail = mysqli_real_escape_string($bdd, $mail);
    $mdp = mysqli_real_escape_string($bdd, $mdp); // Mot de passe en clair
